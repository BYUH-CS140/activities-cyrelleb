document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    var phonenumberValid = /^\+?\d{10,15}$/.test(phonenumber);
    ...
    document.getElementById('phonenumberFeedback').textContent = phonenumberValid ? '' : 'Please enter a valid phone number (e.g., +1234567890 or 1234567890).';
